...
public class ResultMetaS  implements java.io.Serializable {
    private int result;

    private boolean isPrevInherit;

    private com.webservice.ResultMetaData[] metaObjectTypeList;
    ...
    public ResultMetaS(
           ...
           com.webservice.ResultMetaData[] metaObjectTypeList) {
           this.result = result;
    ...
    /**
     * Gets the result value for this ResultMetaS.
     * 
     * @return result
     */
    ...
    /**
     * Sets the result value for this ResultMetaS.
     * 
     * @param result
     */
    ...
    /**
     * Gets the isPrevInherit value for this ResultMetaS.
     * 
    ...
    /**
     * Sets the isPrevInherit value for this ResultMetaS.
     * 
     * @param isPrevInherit
     */
    ...
    /**
     * Gets the metaObjectTypeList value for this ResultMetaS.
     * 
     * @return metaObjectTypeList
     */
    public com.webservice.ResultMetaData[] getMetaObjectTypeList() {
        return metaObjectTypeList;
    }


    /**
     * Sets the metaObjectTypeList value for this ResultMetaS.
     * 
     * @param metaObjectTypeList
     */
    public void setMetaObjectTypeList(com.webservice.ResultMetaData[] metaObjectTypeList) {
        this.metaObjectTypeList = metaObjectTypeList;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ResultMetaS)) return false;
        ResultMetaS other = (ResultMetaS) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ResultMetaS.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", "ResultMetaS"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://tempuri.org/", "ResultMetaData"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("http://tempuri.org/", "ResultMetaData"));
        typeDesc.addFieldDesc(elemField);
    }
